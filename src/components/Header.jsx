...
const Header = () => {
  return (
    <div className="flex flex-col justify-center items-center w-full p-5 mb-4">
      ...
      <p className="font-bold text-white my-2 text-center text-sm md:text-[25px]">
        Get A Guaranteed Cash Offer That Won't Change.
      </p>
      <p className="text-white my-2 md:w-3/5 w-4/5 text-center text-xs md:text-[20px] leading-6">
